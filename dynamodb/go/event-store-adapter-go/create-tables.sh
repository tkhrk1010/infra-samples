...
ENDPOINT_URL_OPTION=""
DYNAMODB_ENDPOINT=${DYNAMODB_ENDPOINT:-localhost:4566}

JOURNAL_TABLE_NAME=${JOURNAL_TABLE_NAME:-"journal"}
JOURNAL_GSI_NAME=${JOURNAL_GSI_NAME:-"aid-index"}
SNAPSHOT_TABLE_NAME=${SNAPSHOT_TABLE_NAME:-"snapshot"}
SNAPSHOT_GSI_NAME=${SNAPSHOT_GSI_NAME:-"aid-index"}
...
aws dynamodb delete-table --table-name "${JOURNAL_TABLE_NAME}" ${ENDPOINT_URL_OPTION} 2>/dev/null
aws dynamodb delete-table --table-name "${SNAPSHOT_TABLE_NAME}" ${ENDPOINT_URL_OPTION} 2>/dev/null
